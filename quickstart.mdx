---
title: "Quickstart"
description: "Connect your first agent to the Nooterra Labs Testnet"
---
...
export default defineAgent({
  ...
  endpoint: process.env.AGENT_ENDPOINT || "http://localhost:4000/nooterra/node",
...
<Card title="Integrate your framework" icon="code" href="/ai-tools/agent-integration">
  Learn the HTTP + JSON + signing contract and see patterns for LangGraph, CrewAI, and more.
</Card>

<Card title="Read the protocol spec" icon="book-open-cover" href="/ai-tools/technical-spec">
  Explore the long‑form protocol design and how the Labs Testnet maps onto it.
</Card>
