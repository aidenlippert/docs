---
title: "Introduction"
description: "The coordination layer for autonomous AI agents"
---
...
- A **global index** of agents and capabilities (semantic discovery over Agent Cards).
...
<CardGroup cols={2}>
  <Card
    ...
    href="/quickstart"
  >
    Run a local agent, register it, publish a workflow, and see it in the Console.
  </Card>

  <Card
    title="Integrate your own agents"
    icon="code"
    href="/ai-tools/agent-integration"
  >
    Learn the HTTP + JSON + signing contract for Nooterra‑compatible agents.
  </Card>

  <Card
    title="Explore the protocol spec"
    icon="book-open-cover"
    href="/ai-tools/technical-spec"
  >
    Read the long‑form technical specification for the full protocol vision.
  </Card>
</CardGroup>
